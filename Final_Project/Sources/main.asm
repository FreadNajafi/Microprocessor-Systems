;***********************************************************
; Ahmad Najafi, Trevor Nice, Anshul Sharma - EEBOT Project *
;***********************************************************
              XDEF Entry, _Startup ;
              ABSENTRY Entry 
...
;Turning timer for eebot (for full left/right turn)
T_LEFT        EQU   6                             
T_RIGHT       EQU   6                             
...
;************************************************
; Main Code Entry Point and Initialization Logic
;************************************************
...
;***************************************************************************************************
; Forward State (FWD_ST): Handles forward movement logic and transitions based on sensor readings
;***************************************************************************************************
...
;***************************************************************************************************
; NOT_ALIGNED: Handles misalignment by determining the corrective action (left/right alignment)
;***************************************************************************************************
...
;***************************************************************************************************
; PARTIAL_LEFT_TRN: Executes a partial left turn to correct misalignment
;***************************************************************************************************
...
;***************************************************************************************************
; PARTIAL_RIGHT_TRN: Executes a partial right turn to correct misalignment
;***************************************************************************************************
...
;***************************************************************************************************
; LEFT and RIGHT: Handles transitions for forward movement after successful alignment
;***************************************************************************************************
...
;***************************************************************************************************
; REV_TRN_ST: Handles reverse turning logic based on sensor readings
;***************************************************************************************************
...
;***************************************************************************************************
; ALL_STOP_ST: Handles the transition to a complete stop and resets state to START
;***************************************************************************************************
...
;***************************************************************************************************
; Initialization Subroutines: Configure motor movement and behavior
;***************************************************************************************************
