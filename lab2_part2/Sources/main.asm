...
;********************************************
   ...
   ; Hex Data at specified locations ($3000 and $3001)
                  ORG       $3000
                  
HEX1              FCB       $F1                 ; ASCII Character
HEX2              FCB       $E2                 ; ASCII Character

;Data Memory for ASCII Storage and Hex Data
                  ORG       $3500               ; Start the data section at a safe location
mem1              RMB       01                ; leftHLF of HEX1
mem2              RMB       01
mem3              RMB       01
mem4              RMB       01
mem5              RMB       01
...
MainLoop          JSR       clrLCD            ; clear LCD & home cursor
                  LDX       #msg1             ; Load address of the message
                  JSR       putsLCD           ; Display the message
                  
                  LDAA      $3000             ; load contents from $3000 into A
                  JSR       leftHLF           ; convert left half of A into ASCII
                  STAA      mem1              ; store the ASCII byte into mem1
                  LDAA      $3000             ; load contents from $3000 again
                  JSR       rightHLF          ; convert right half of A into ASCII
                  STAA      mem2              ; store the ASCII byte into mem2
                  
                  LDAA      $3001             ; load contents from $3001
                  JSR       leftHLF           ; convert left half of A into ASCII
                  STAA      mem3              ; store the ASCII byte into mem3
                  LDAA      $3001             ; load contents from $3001 into A
                  JSR       rightHLF          ; convert right half of A into ASCII
                  STAA      mem4              ; store the ASCII byte into mem4
                  
                  LDAA      #$00              ; load 0 into A (Null terminator for the string)
                  STAA      mem5              ; store string termination character 00 into mem5
                  
                  LDX       #mem1             ; Load memory with ASCII values
                  JSR       putsLCD           ; Display the 4 characters
                  
                  LDY       #20000            ; Delay = 1s
                  JSR       del_50us          ; Delay
                  BRA       MainLoop          ; Loop forver
                  
msg1              dc.b      "Hello! ",0       ; message to be displayed
...
clrLCD            LDAA      #$01              ; clear cursor and return to home position
                  JSR       cmd2LCD           ; -"-
                  LDY       #4000               ; wait until "clear cursor" command is complete
                  JSR       del_50us          ; -"-
                  RTS
