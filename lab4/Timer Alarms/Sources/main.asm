...
AT_DEMO     RMB 1 ; The alarm time (demo)
...
;subroutine section
;*******************************************************************
;* Initialize LCD: 4-bit data width, 2-line display, *
;* Display On, cursor and blinking off. Cursor Shift right. *
;*******************************************************************
...
;*******************************************************************
;* Sends a command in accumulator A to the LCD screen *
;*******************************************************************
...
;*******************************************************************
;* outputs the character in accumulator in A to LCD screen *
;*******************************************************************
...
;*******************************************************************
;* Data transfer to the LCD IR or DR depening on RS *
;*******************************************************************
